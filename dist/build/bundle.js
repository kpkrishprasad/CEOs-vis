...
var app = (function () {
    ...
    function axis(orient, scale) {
      ...
      function axis(context) {
        var values = tickValues == null ? (scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain()) : tickValues,
            ...
            position = (scale.bandwidth ? center$1 : number)(scale.copy(), offset),
    ...
    function selectAll(selector) {
      return typeof selector === "string"
          ...
          : new Selection$1([array$3(selector)], root$1);
    }
    ...
    const tau$2 = 2 * Math.PI, pow$1 = Math.pow;
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div7, "border", "1px solid #ccc");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*scrollLeft*/ ctx[7], false, false, false, false),
    					listen_dev(button1, "click", /*scrollRight*/ ctx[8], false, false, false, false)
    				];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let industryData = {};
    	let industries = [];
    	const xScale = band().range([0, width]).padding(0.2); // Increased padding for more spacing between boxes
    	...
    	onMount(async () => {
    		...
    		industries = Object.keys(industryData).map(industry => {
    			let medianPay = quantile$1(industryData[industry].map(d => d.ceoPay).sort(ascending$3), 0.5);
    			return { industry, medianPay };
    		}).sort((a, b) => ascending$3(a.medianPay, b.medianPay)).map(d => d.industry);
    		...
    		chartSvg.node().parentNode.addEventListener('scroll', () => {
    			$$invalidate(2, divTopScroll.scrollLeft = chartSvg.node().parentNode.scrollLeft, divTopScroll);
    		});

    		// Draw Y-Axis
    		yAxisSvg.append("g").attr("transform", `translate(${margin.left}, 0)`).call(axisLeft(yScale).ticks(10).tickFormat(d => d.toLocaleString()));
    	...
    	function drawChart(chartSvg) {
    		industries.forEach(industry => {
    			let industryCeoData = industryData[industry].map(d => d.ceoPay).sort(ascending$3);
    			let q1 = quantile$1(industryCeoData, 0.25);
    			let median = quantile$1(industryCeoData, 0.5);
    			let q3 = quantile$1(industryCeoData, 0.75);
    			let iqr = q3 - q1;
    			max$3([min$2(industryCeoData), q1 - 1.5 * iqr]);
    			min$2([max$3(industryCeoData), q3 + 1.5 * iqr]);

    			// Draw Box
    			chartSvg.append("rect").attr("x", xScale(industry)).attr("y", yScale(q3)).attr("width", xScale.bandwidth()).attr("height", yScale(q1) - yScale(q3)).style("fill", "#69b3a2").style("stroke", "black").on("mouseover", event => showTooltip(event, industry)).on("mousemove", event => showTooltip(event, industry)).on("mouseout", hideTooltip);

    			// Draw Median Line
    			chartSvg.append("line").attr("x1", xScale(industry)).attr("x2", xScale(industry) + xScale.bandwidth()).attr("y1", yScale(median)).attr("y2", yScale(median)).style("stroke", "red").style("stroke-width", "2px");

    			// Add Labels
    			chartSvg.append("text").attr("x", xScale(industry) + xScale.bandwidth() / 2).attr("y", yScale(q3) - 10).attr("text-anchor", "middle").attr("font-size", "12px").attr("fill", "black").text(industry); // Position above the box, adjusted for more space

    			// Handle single company case
    			if (industryCeoData.length === 1) {
    				chartSvg.append("circle").attr("cx", xScale(industry) + xScale.bandwidth() / 2).attr("cy", yScale(median)).attr("r", 5).style("fill", "#69b3a2").style("stroke", "black").on("mouseover", event => showTooltip(event, industry)).on("mousemove", event => showTooltip(event, industry)).on("mouseout", hideTooltip);
    			}
    		});
    	}
    ...
    `,
    		...
    		$$invalidate(3, tooltip.style.left = `${event.pageX + 15}px`, tooltip);
    		$$invalidate(3, tooltip.style.top = `${event.pageY - 28}px`, tooltip);
    		$$invalidate(3, tooltip.style.display = "block", tooltip);
    	}

    	function hideTooltip() {
    		$$invalidate(3, tooltip.style.display = "none", tooltip);
    	}

    	function scrollLeft() {
    		$$invalidate(2, divTopScroll.scrollLeft -= 100, divTopScroll);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('svgChart' in $$props) $$invalidate(0, svgChart = $$props.svgChart);
    		if ('svgYAxis' in $$props) $$invalidate(1, svgYAxis = $$props.svgYAxis);
    		if ('divTopScroll' in $$props) $$invalidate(2, divTopScroll = $$props.divTopScroll);
    		...
    		if ('industryData' in $$props) industryData = $$props.industryData;
    		if ('industries' in $$props) industries = $$props.industries;
    	};
    ...
    /* src/components/Scatterplot.svelte generated by Svelte v3.59.2 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			p0 = element("p");
    			p0.textContent = "Hover over the points to see details. Click on a point to highlight. Zoom in/out.";
    			t1 = space();
    			div1 = element("div");
    			t2 = space();
    			div2 = element("div");
    			...
    			add_location(p0, file$2, 106, 2, 3058);
    			attr_dev(div0, "class", "user-instructions");
    			add_location(div0, file$2, 105, 0, 3024);
    			attr_dev(div1, "id", "scatterplot");
    			add_location(div1, file$2, 110, 0, 3160);
    			attr_dev(p1, "class", "svelte-tjdh9z");
    			add_location(p1, file$2, 112, 2, 3223);
    			attr_dev(div2, "class", "graph explanation");
    			add_location(div2, file$2, 111, 0, 3189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		const colorScale = ordinal(category10).domain(industries);
    		...
    		const svg = select("#scatterplot").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", `translate(${margin.left},${margin.top})`);
    		const x = linear$1().domain([0, max$3(ceoData, d => d.payRatio)]).range([0, width]);
    		const y = linear$1().domain([0, max$3(ceoData, d => d.employeePay)]).range([height, 0]);
    		svg.append("g").attr("transform", `translate(0,${height})`).call(axisBottom(x));
    		svg.append("g").call(axisLeft(y));
    		const tooltip = select("#scatterplot").append("div").attr("class", "tooltip").style("opacity", 0);

    		svg.selectAll("circle").data(ceoData).enter().append("circle").attr("cx", d => x(d.payRatio)).attr("cy", d => y(d.employeePay)).attr("r", 5).style("fill", d => colorScale(d.Industry)).on("mouseover", (event, d) => {
    			tooltip.transition().duration(200).style("opacity", 1);
    			tooltip.html(`Industry: ${d.Industry}<br/>Company: ${d.company}<br/>CEO: ${d.ceo}<br/>CEO Pay: ${d.ceoPay}<br/>Median Worker Pay: ${d.employeePay}`).style("left", `${event.pageX + 5}px`).style("top", `${event.pageY - 28}px`);
    		}).on("mouseout", () => {
    			tooltip.transition().duration(500).style("opacity", 0);
    		});

    		// Two-column legend
    		const legend = svg.append("g").attr("font-family", "sans-serif").attr("font-size", 10).attr("text-anchor", "start").selectAll("g").data(industries.slice().sort()).enter().append("g").attr("transform", (d, i) => `translate(${width + 24 + i % 2 * 120}, ${Math.floor(i / 2) * 20})`);
    ...
    /* src/components/Top10Bottom10.svelte generated by Svelte v3.59.2 */

    const { console: console_1 } = globals;
    const file$1 = "src/components/Top10Bottom10.svelte";

    // (196:4) {#if selectedCompany}
    function create_if_block(ctx) {
    	let div;
    	let p0;
    	let strong0;
    	let t1;
    	let t2_value = /*selectedCompany*/ ctx[0].company + "";
    	let t2;
    	let t3;
    	let p1;
    	let strong1;
    	let t5;
    	let t6_value = /*selectedCompany*/ ctx[0].ceo + "";
    	let t6;
    	let t7;
    	let p2;
    	let strong2;
    	let t9;
    	let t10_value = /*selectedCompany*/ ctx[0].ceoPay + "";
    	let t10;
    	let t11;
    	let p3;
    	let strong3;
    	let t13;
    	let t14_value = /*selectedCompany*/ ctx[0].employeePay + "";
    	let t14;
    	let t15;
    	let p4;
    	let strong4;
    	let t17;
    	let t18_value = /*selectedCompany*/ ctx[0].payRatio + "";
    	let t18;
    	let t19;
    	let p5;
    	let strong5;
    	let t21;
    	let t22_value = /*selectedCompany*/ ctx[0].Industry + "";
    	let t22;
    	...
    	const block = {
    		c: function create() {
    			...
    			strong0.textContent = "Company:";
    			t1 = space();
    			t2 = text$1(t2_value);
    			t3 = space();
    			p1 = element("p");
    			strong1 = element("strong");
    			strong1.textContent = "CEO:";
    			t5 = space();
    			t6 = text$1(t6_value);
    			t7 = space();
    			p2 = element("p");
    			strong2 = element("strong");
    			strong2.textContent = "CEO Pay:";
    			t9 = text$1(" $");
    			t10 = text$1(t10_value);
    			t11 = space();
    			p3 = element("p");
    			strong3 = element("strong");
    			strong3.textContent = "Average Worker Pay:";
    			t13 = text$1(" $");
    			t14 = text$1(t14_value);
    			t15 = space();
    			p4 = element("p");
    			strong4 = element("strong");
    			strong4.textContent = "Pay Ratio:";
    			t17 = space();
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*selectedCompany*/ 1 && t2_value !== (t2_value = /*selectedCompany*/ ctx[0].company + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*selectedCompany*/ 1 && t6_value !== (t6_value = /*selectedCompany*/ ctx[0].ceo + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*selectedCompany*/ 1 && t10_value !== (t10_value = /*selectedCompany*/ ctx[0].ceoPay + "")) set_data_dev(t10, t10_value);
    			if (dirty & /*selectedCompany*/ 1 && t14_value !== (t14_value = /*selectedCompany*/ ctx[0].employeePay + "")) set_data_dev(t14, t14_value);
    			if (dirty & /*selectedCompany*/ 1 && t18_value !== (t18_value = /*selectedCompany*/ ctx[0].payRatio + "")) set_data_dev(t18, t18_value);
    			if (dirty & /*selectedCompany*/ 1 && t22_value !== (t22_value = /*selectedCompany*/ ctx[0].Industry + "")) set_data_dev(t22, t22_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(196:4) {#if selectedCompany}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let t10;
    	let a;
    	let if_block = /*selectedCompany*/ ctx[0] && create_if_block(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Top10Bottom10', slots, []);
    	let data = [];
    	let top10 = [];
    	let bottom10 = [];
    	...
    	function drawChart(data, selector, title, margin, width, height) {
    		const svg = select(selector).append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", `translate(${margin.left},${margin.top})`);
    		const x = band().range([0, width]).padding(0.2).domain(data.map(d => d.company));
    		const y = linear$1().range([height, 0]).domain([0, max$3(data, d => d.payRatio)]);

    		svg.append("g").selectAll(".bar").data(data).enter().append("g").attr("class", "bar").attr("transform", d => `translate(${x(d.company)}, 0)`).each(function (d, i) {
    			const g = select(this);

    			// Draw the main bar (building)
    			g.append("rect").attr("x", 0).attr("y", y(d.payRatio)).attr("width", x.bandwidth()).attr("height", height - y(d.payRatio)).attr("fill", "darkgray").on("mouseover", () => {
    				$$invalidate(0, selectedCompany = d);
    			});
    			...
    			for (let j = 0; j < numWindows; j++) {
    				g.append("rect").attr("x", (x.bandwidth() - windowWidth) / 2).attr("y", y(d.payRatio) + j * (windowHeight + windowSpacing) + windowSpacing).attr("width", windowWidth).attr("height", windowHeight).attr("fill", "lightgray");
    			}
    			...
    			g.append("rect").attr("x", doorX).attr("y", height - doorHeight).attr("width", doorWidth).attr("height", doorHeight).attr("fill", "saddlebrown");

    			// Add a vertical line in the middle of the door
    			g.append("line").attr("x1", doorX + doorWidth / 2).attr("y1", height - doorHeight).attr("x2", doorX + doorWidth / 2).attr("y2", height).attr("stroke", "black").attr("stroke-width", "1");
    		});

    		svg.append("g").attr("class", "x-axis").attr("transform", `translate(0,${height})`).call(axisBottom(x)).selectAll("text").attr("transform", "rotate(-45)").style("text-anchor", "end");
    		svg.append("g").attr("class", "y-axis").call(axisLeft(y));
    		svg.append("text").attr("x", width / 2).attr("y", -10).attr("text-anchor", "middle").style("font-size", "16px").text(title);
    		svg.append("text").attr("x", -height / 2).attr("y", -40).attr("text-anchor", "middle").attr("transform", "rotate(-90)").style("font-size", "12px").text("Pay Ratio");
    	}

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Top10Bottom10> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('top10' in $$props) top10 = $$props.top10;
    		if ('bottom10' in $$props) bottom10 = $$props.bottom10;
    		if ('selectedCompany' in $$props) $$invalidate(0, selectedCompany = $$props.selectedCompany);
    	};
    ...
    class Top10Bottom10 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	top10bottom10 = new Top10Bottom10({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "CEO Data Visualizations";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Lacha Barton-Gluzman, Krish Prasad, Ishaan Bal";
    			t3 = space();
    			create_component(linechart.$$.fragment);
    			t4 = space();
    			create_component(scatterplot.$$.fragment);
    			t5 = space();
    			create_component(top10bottom10.$$.fragment);
    			attr_dev(h1, "class", "svelte-33jf8m");
    			add_location(h1, file, 7, 1, 214);
    			add_location(p, file, 8, 1, 248);
    			attr_dev(main, "class", "svelte-33jf8m");
    			add_location(main, file, 6, 2, 206);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t5);
    			mount_component(top10bottom10, main, null);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    			...
    			transition_in(top10bottom10.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(linechart.$$.fragment, local);
    			transition_out(scatterplot.$$.fragment, local);
    			transition_out(top10bottom10.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(top10bottom10);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ LineChart, Scatterplot, Top10Bottom10 });
    	return [];
    }
